...
export const metadata: Metadata = {
	title: "Help Center - Customer Support | Zugzology",
	description: "Get help with your orders, shipping, returns, and more. Find answers to frequently asked questions or contact our support team for assistance.",
	openGraph: {
		title: "Help Center - Customer Support | Zugzology",
		...
		images: [
			{
				url: "https://zugzology.com/help-og-image.jpg",
				width: 1200,
				height: 630,
				alt: "Zugzology Help Center",
			},
		],
	},
	twitter: {
		...
		title: "Help Center - Customer Support | Zugzology",
		description: "Get help with your orders, shipping, returns, and more. Find answers to frequently asked questions or contact our support team.",
		images: ["https://zugzology.com/help-twitter-image.jpg"],
	},
	robots: {
		index: true,
		follow: true,
