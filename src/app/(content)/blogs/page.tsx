						...
						{post.image ? (
							...
							<div className="absolute inset-0 flex items-center justify-center bg-muted p-4 text-center dark:bg-muted">
								<div className="space-y-2">
									...
									<p className="text-muted-foreground text-xs dark:text-muted-foreground">Still Growing...</p>
								</div>
							</div>
						)}
					</div>
					...
					<div className="container mx-auto px-4 py-12">
						...
						<div className="grid grid-cols-2 gap-4 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5">
							{blogs.map((blogCategory) => (
								<Link
									className="group flex items-center rounded-lg border border-border bg-white p-3 transition-colors hover:bg-accent dark:border-border dark:bg-muted dark:hover:bg-accent"
