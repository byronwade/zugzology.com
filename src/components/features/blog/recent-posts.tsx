...
export function RecentPosts({ posts }: RecentPostsProps) {
	...
	return (
		<div className="border-t pt-16 dark:border-neutral-800">
			<h2 className="mb-8 font-bold text-2xl text-neutral-900 dark:text-neutral-100">Latest from Our Blog</h2>
