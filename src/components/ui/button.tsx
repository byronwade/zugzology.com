...
/**
 * Mirrors the current ui.shadcn.com button recipe: `shadow-xs` on filled
 * variants, a 3px ring drawn on the border rather than an offset outline, and
 * padding that tightens when the label is icon-only.
 */
