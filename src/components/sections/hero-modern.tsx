...
export function HeroModern({ products = [] }: HeroModernProps) {
	...
	return (
		<section className="relative min-h-[calc(90vh-var(--header-height))] overflow-hidden bg-background">
			...
			<div className="container relative z-10 mx-auto px-4">
				<div className="flex min-h-[calc(90vh-var(--header-height))] items-center">
					<div className="grid w-full items-center gap-12 lg:grid-cols-2 lg:gap-16">
						...
						>
							...
							<div className="space-y-4">
								<h1 className="font-bold text-4xl text-foreground leading-[1.1] tracking-tight sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl">
									Grow
									<br />
							...
							<div className="grid grid-cols-3 gap-4 pt-8 sm:gap-6 lg:gap-8">
								<div className="space-y-1">
									<div className="font-bold text-2xl text-foreground sm:text-3xl">10K+</div>
									<div className="text-muted-foreground text-xs sm:text-sm">Growers</div>
								</div>
								<div className="space-y-1">
									<div className="font-bold text-2xl text-foreground sm:text-3xl">95%</div>
									<div className="text-muted-foreground text-xs sm:text-sm">Success</div>
								</div>
								<div className="space-y-1">
									<div className="font-bold text-2xl text-foreground sm:text-3xl">24/7</div>
									<div className="text-muted-foreground text-xs sm:text-sm">Support</div>
								</div>
							</div>
						</div>
						...
						{featuredProduct?.images?.nodes?.[0] && (
							<div
								className={`relative hidden transition-all delay-300 duration-1000 lg:block ${isVisible ? "translate-x-0 opacity-100" : "translate-x-8 opacity-0"}`}
							>
									...
									<div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/0 to-transparent">
										<div className="absolute right-0 bottom-0 left-0 p-8 text-white">
											<div className="space-y-2">
												<div className="inline-block rounded-full bg-primary px-3 py-1 font-medium text-xs">
													Featured
												</div>
