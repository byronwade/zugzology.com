			...
			<div className="ds-container" style={{ backgroundColor: "#FFEED1" }}>
				<div className="content">
					<div className="text-area">
						...
						<p className="ds-des" style={{ fontWeight: 500 }}></p>
					</div>
					<div className="wrappp">
						<div className="img-icon-wrap">
							<Image className="icon-img" src="/icons/icon-01.png" alt="High Yield" width={100} height={100} />
						...
						<div className="img-icon-wrap">
							<Image className="icon-img" src="/icons/icon-02.png" alt="Simple Setup" width={100} height={100} />
							<div className="column--text">
						...
						<div className="img-icon-wrap">
							<Image className="icon-img" src="/icons/video2.png" alt="Video Guides" width={100} height={100} />
							<div className="column--text">
